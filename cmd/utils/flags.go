...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/zsmartex/whisper")
	}
}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	default:
		...
		cfg.Genesis = core.DefaultZSmartGenesisBlock()
		SetDNSDiscoveryDefaults(cfg, params.ZSmartGenesisHash)
	}
}
