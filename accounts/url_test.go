...
func TestURLParsing(t *testing.T) {
	url, err := parseURL("https://zsmartex.org")
	if err != nil {
...
func TestURLString(t *testing.T) {
	...
	if url.String() != "https://zsmartex.org" {
		t.Errorf("expected: %v, got: %v", "https://zsmartex.org", url.String())
	}
...
func TestURLMarshalJSON(t *testing.T) {
	...
	if string(json) != "\"https://zsmartex.org\"" {
		t.Errorf("expected: %v, got: %v", "\"https://zsmartex.org\"", string(json))
	}
}

func TestURLUnmarshalJSON(t *testing.T) {
	url := &URL{}
	err := url.UnmarshalJSON([]byte("\"https://zsmartex.org\""))
	if err != nil {
		t.Errorf("unexpcted error: %v", err)
	}
	if url.Scheme != "https" {
